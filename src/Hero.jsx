      ...
      <div className="hero-inner container">
        <div className="hero-left" style={{ transform: `translateY(${-parallax * 0.15}px)` }}>
          ...
          <div className="hero-ctas">
            <button className="btn btn-primary" onClick={onBuy}>OUT NOW → <span style={{ fontSize: '1.1em' }}>→</span></button>
            <a href="enter.html" className="btn btn-ghost">Join the Fold</a>
          </div>
          <div className="hero-listen">
            <span className="mono-label muted">A psychedelic space opera</span>
            <span className="divider-dot" />
            <span className="mono-label muted">Available today</span>
          </div>
        </div>
        ...
        <div className="hero-right" style={{ transform: `translateY(${parallax * 0.1}px) rotate(${-2 + scrollY * 0.005}deg)` }}>
          ...
          <div className="cover-caption">
            <span className="mono-label muted">First Edition</span>
          </div>
        </div>
      </div>
